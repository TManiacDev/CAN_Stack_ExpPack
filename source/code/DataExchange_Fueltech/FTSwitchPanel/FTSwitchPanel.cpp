...
Std_ReturnType FT_SwitchPanel::Init(void)
{
  ...
  GetHwInterface()->ConnectUpperLayerIndication(CanIf_Rx_SwitchPanel_Mini4_Ctrl, this);
  CanFT2p0::Init();
  returnValue = E_OK;
  return returnValue;
}
...
Std_ReturnType FT_SwitchPanel::SendState(void)
{
  ...
  TxIndication(CanIf_Tx_SwitchPanel_Mini4, &myPanelPdu);
  GetHwInterface()->Receive(CanIf_Rx_SwitchPanel_Mini4_Ctrl, &myPanelCtrlPdu);
